...
def eval_edges(model, dataset, params):
    ...
    return f1, correct_edges / (full_edge_count + 1e-8), correct_0_edges / (edge_0_count + 1e-8), correct_1_edges / (edge_1_count + 1e-8), correct_2_edges / (edge_2_count + 1e-8), all_edges
